...
$(function () {
	$('.btns').click(function () {
		...
		$.ajax({
			...
			{
				alert(result);
				let res=JSON.parse(result); //문자열을 JSON으로 변경해라
				let data="";
		...
		success:function(result){
			...
			data=res.map((m)=>(
				  '<div class="col-md-3">'
				    +'<div class="thumbnail">'
				      +'<a href="#">'
				        +'<img src="'+m.poster+'" alt="Lights" style="width:350px">'
				        +'<div class="caption">'
				         +'<p>'+m.name+'</p>'
				        +'</div>'
				      +'</a>'
  ...
  <div class="container">
    <div class="row">
      <div class="text-center">
        ...
        <input type="button" value="감성" class="btn btn-lg btn-info btns" data-type="3">
        <input type="button" value="스타일" class="btn btn-lg btn-success btns" data-type="4">
      </div>
    </div>
