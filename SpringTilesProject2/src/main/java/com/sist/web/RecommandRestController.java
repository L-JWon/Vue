...
public class RecommandRestController {
	...
	@GetMapping(value = "recommand/recommand_sub.do",produces = "text/plain;charset=UTF-8") //정석 ajax 
	public String recommand_sub(int type)
	{
		...
		if(type==1)
		{
			list=Arrays.asList(type1); //arraylist에 넣어주는 메소드
		}
		else if(type==2)
		{
